...
declare module 'pushy-sdk-web' {
    ...
    export function setNotificationListener(callback: (data: unknown) => void): void;
...
declare type LoadingStatus = 'IDLE' | 'FETCH_IN_PROGRESS' | 'FETCH_SUCCEEDED' | 'FETCH_FAILED';
declare module '@greatsumini/react-facebook-login' {
    import type { DialogParams, InitParams, LoginResponse } from '@greatsumini/react-facebook-login';
    type LoginOptions = {
    ...
    export default function FacebookLogin(props: FacebookLoginProps): JSX.Element;
    type FacebookLoginProps = Pick<InitParams, 'appId'> & {
        /** @default 'en_US' */
        language?: string;
        ...
        render?: (props: { onClick?: () => void; logout?: FB['logout'] }) => ReactElement;

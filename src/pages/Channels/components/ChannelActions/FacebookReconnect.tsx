...
import { updateFacebook } from '@/services/api/channel';
...
const FacebookReconnect = (props: Props) => {
    ...
    const serialize = useCallback(async () => {
        try {
            ...
            console.error('Update Facebook Channel error: ', error);
            setIsLoading(false);
            dispatch(
                pushNotification({
...
export default FacebookReconnect;

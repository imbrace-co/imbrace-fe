...
const MessageModalListBody: FC<MessageModalListBodyProps> = (props) => {
    const {
        ...
        msgId,
        isJoined,
        teamConversationUsers,
        teamConversationContact,
        contactId,
        channelType,
        teamConversationUserId,
    } = props;
    ...
    const fetchMessage = useCallback(async () => {
        try {
            if (teamConversationUserId) {
                setLoading(true);
                const teamConvId = teamConversationUserId;
    ...
    }, [pagination.skip, teamConversationUserId, pagination.limit]);

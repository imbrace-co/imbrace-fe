...
import { CRM_BOARD_TYPES } from './index';
                                    ...
                                    <Space size={0} style={{ width: '100%' }}>
                                        <Select
                                            ...
                                            querySelect={(boards: API.Board[]) => {
                                                // The /crm route lists CRM boards only. Whitelist the CRM entity
                                                // types so other/unknown types never leak in (they have their own routes).
                                                return boards
                                                    .filter((option) => !crm || CRM_BOARD_TYPES.includes(option.type))
                                                    .map((option) => ({
                ...
                {!isFilterVisible && (
                    <Space style={{ width: '100%', border: '1px solid #135DD5', borderBottom: 'none' }} size={0}>
                        ...
                        <Space
                            ...
                            justify="between"
                            style={{
                                ...(isDataboardsRoute ? { flex: 0.6 } : { width: '128px' }),
                                height: '40px',
                                padding: '0 8px',
                        ...
                        {isDataboardsRoute && (
                            <Space
                                ...
                                align="center"
                                justify="between"
                                style={{ flex: 1.5, height: '40px', padding: '0 8px', borderRight: '1px solid #135DD5' }}
                            >
                                <SegmentationButton />
                                <Box sx={{ width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '8px', flexShrink: 0 }}>
                        ...
                        {/* Search */}
                        <div style={isDataboardsRoute ? { flex: 1 } : { width: '100%' }}>
                            <SearchBar
                                ref={searchBarRef}
                                onSearch={(searchText) => {

...
interface Props {
    ...
    onClose?: () => void;
    identifierField?: API.BoardField;
    crm?: boolean;
}
...
> = {
    web: {
        icon: <Icon namespace="channel" name="web" />,
    },
    whatsapp: {
        icon: <Icon namespace="channel" name="whatsapp" />,
    },
    facebook: {
        icon: <Icon namespace="channel" name="facebook" />,
    },
    email: {
        icon: <Icon namespace="channel" name="email" />,
    },
    wechat: {
        icon: <Icon namespace="channel" name="wechat" />,
    },
    line: {
        icon: <Icon namespace="channel" name="line" />,
    },
    instagram: {
        icon: <Icon namespace="channel" name="instagram" />,
    },
};

const ModalHeader = (props: Props) => {
    const { isEditMode = 'manual', selectedRowInfo, conversationIds, onClose, identifierField, crm } = props;

...
import MapToTableIcon from '@/assets/icons/icon_map_table.svg?react';
...
export const FieldTypeText = {
    ...
    TableInTable: 'databoard_table_in_table',
    ...
    MultipleAssignee: 'field_multiple_assignee',
    Origin: 'field_origin',
...
export const FieldTypeTextDataboard: typeof FieldTypeText = {
    ShortText: 'databoard_field_short_text',
    LongText: 'databoard_field_long_text',
    TableInTable: 'databoard_field_table_in_table',
    SingleSelection: 'databoard_field_single_selection',
    MultipleSelection: 'databoard_field_multiple_selection',
    Number: 'field_number',
    Date: 'field_date',
    Time: 'field_time',
    Datetime: 'databoard_field_datetime',
    Email: 'field_email',
    Phone: 'field_phone',
    Link: 'databoard_field_link',
    Country: 'field_country',
    Priority: 'field_priority',
    Assignee: 'databoard_field_assignee',
    MultipleAssignee: 'databoard_field_multiple_assignee',
    Origin: 'databoard_field_origin',
    Attachment: 'databoard_field_attachment',
    Notes: 'databoard_field_notes',
    Currency: 'field_currency',
    Checkbox: 'databoard_field_checkbox',
};

export const FieldTypesOptions = (t: TFunction, isDocumentAIRoute?: boolean) => {
    const k = (databoardKey: string, defaultKey: string) => (isDocumentAIRoute ? databoardKey : defaultKey);
    return [
        {
            value: 'TableInTable',
            text: (
                ...
                >
                    {t(k('databoard_field_table_in_table', 'databoard_table_in_table'))}
                    <TooltipWithHelpIcon placement="top" title={t('databoard_table_in_table_tooltip')} />
                </span>
            ),
            icon: <MapToTableIcon />,
        },
        {
            value: 'ShortText',
            text: t(k('databoard_field_short_text', 'field_short_text')),
            icon: <Icon name="shortText" fontSize={24} />,
        },
        {
            value: 'LongText',
            text: t(k('databoard_field_long_text', 'field_long_text')),
            icon: <Icon name="longText" fontSize={24} />,
        },
        {
            value: 'SingleSelection',
            text: t(k('databoard_field_single_selection', 'field_single_selection')),
            icon: <Icon name="singleSelection" fontSize={24} />,
        },
        {
            value: 'MultipleSelection',
            text: t(k('databoard_field_multiple_selection', 'field_multiple_selection')),
        ...
        {
            value: 'Datetime',
            text: t(k('databoard_field_datetime', 'field_datetime')),
        ...
        {
            value: 'Link',
            text: t(k('databoard_field_link', 'field_link')),
            icon: <Icon name="linkSide" fontSize={24} />,
        },
        {
            value: 'Checkbox',
            text: t(k('databoard_field_checkbox', 'field_checkbox')),
        ...
        {
            value: 'Assignee',
            text: t(k('databoard_field_assignee', 'field_assignee')),
            icon: <Icon name="assignee" fontSize={24} />,
        },
        {
            value: 'MultipleAssignee',
            text: t(k('databoard_field_multiple_assignee', 'field_multiple_assignee')),
            icon: <Icon name="assignee" fontSize={24} />,
        },
        {
            value: 'Origin',
            text: t(k('databoard_field_origin', 'field_origin')),
            icon: <Icon name="mindMap" fontSize={24} />,
        },
        {
            value: 'Attachment',
            text: t(k('databoard_field_attachment', 'field_attachment')),
            icon: <Icon name="attachment" fontSize={24} />,
        },
        {
            value: 'Notes',
            text: t(k('databoard_field_notes', 'field_notes')),

declare namespace API {
    ...
    type BoardType = 'Contacts' | 'Companies' | 'Opportunities' | 'Tasks' | 'Products' | 'General' | 'OptOut' | 'System' | 'KnowledgeHub' | 'DocumentAI';
    ...
    interface BoardConnectionsResponse {
    ...
    interface Board {
        ...
        show_id?: boolean;
        is_child_table?: boolean;
        attached_from?: AttachedFrom | null;
        from_schema_id?: string | null;
        items_count?: number;
        /** Category linkage (mirrors /schemas): read shape on the board. */
        category_id?: string | null;
        /** Category linkage write shape (request body — camelCase per spec). */
    ...
    interface DataBoardFile {
        ...
        tags: string[];
        remarks: string;
        last_updated_by: User<string, any>; // replace later
        source_type: string;
        sync_timestamp: Date;
        updated_at?: Date;
        key: string;
